...
const EMULATOR_TEST_USERS = [
  ...
  { email: 'hod.test@utd.ac.th', label: 'หัวหน้ากลุ่มสาระฯ คณิต', roleTag: 'HEAD_OF_DEPARTMENT', desc: 'อนุมัติสอนแทน ขั้น 1 (ผู้เสนอ)' },
  { email: 'academic.test@utd.ac.th', label: 'หัวหน้าฝ่ายวิชาการฯ', roleTag: 'ACADEMIC_HEAD', desc: 'อนุมัติสอนแทน ขั้น 2' },
  { email: 'deputy.test@utd.ac.th', label: 'รองผู้อำนวยการฝ่ายวิชาการ', roleTag: 'DEPUTY_DIRECTOR_ACADEMIC', desc: 'อนุมัติสอนแทน ขั้น 3 + เช็คชื่อย้อนหลัง' },
  { email: 'director.test@utd.ac.th', label: 'ผู้อำนวยการสถานศึกษา', roleTag: 'DIRECTOR', desc: 'อนุมัติสอนแทน ขั้น 4 (สุดท้าย)' },
